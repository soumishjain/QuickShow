...
const UpcomingMovieCard = ({movie}) => {
  ...
  return (
     <div  className='cursor-pointer hover:-translate-y-1 transition-transform duration-300 flex flex-col justify-between h-92 w-68 bg-primary/10 border-2 border-primary/20 rounded-2xl p-3'>
      <div>
